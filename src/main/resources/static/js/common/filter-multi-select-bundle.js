(function ($) {
    ...
    $__default['default'].fn.filterMultiSelect = function (args) {
      ...
      if (typeof args.placeholderText === 'undefined') args.placeholderText = '진료과목';
      if (typeof args.filterText === 'undefined') args.filterText = '진료과목';
      if (typeof args.selectAllText === 'undefined') args.selectAllText = '전체 선택';
